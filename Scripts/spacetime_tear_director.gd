...
@export var min_wave_for_tears: int = 6
@export var scar_intensity_threshold: float = 0.58
@export var intensified_scar_threshold_bonus: float = -0.08
@export var spawn_cooldown: float = 8.5
@export var max_active_tears: int = 4
@export var max_alive_tear_enemies: int = 10
@export var max_enemies_per_tear: int = 3
@export var tear_lifetime: float = 4.2
@export var first_spawn_delay: float = 0.46
@export var spawn_interval: float = 0.72
